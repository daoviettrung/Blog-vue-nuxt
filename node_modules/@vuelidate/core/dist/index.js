...
function unwrap(val) {
  return vueDemi.isRef(val) ? val.value : val;
}
...
function createAsyncResult(rule, model, $pending, $dirty, _ref, $response, instance) {
  ...
  $pending.value = false;
  var $unwatch = vueDemi.watch([model, $dirty], function (_ref2) {
...
function nestedValidations(_ref) {
  ...
  var sendValidationResultsToParent = vueDemi.inject(VuelidateInjectChildResults, function () {}); // provide to all of it's children the send results to parent function

  vueDemi.provide(VuelidateInjectChildResults, injectChildResultsIntoParent);
  var removeValidationResultsFromParent = vueDemi.inject(VuelidateRemoveChildResults, function () {}); // provide to all of it's children the remove results  function
